...
def main() -> int:  # noqa: PLR0915
    ...
    from app.api.credits import InsufficientCreditsError, spend_credits_for_user, spend_credits_once_for_user
    ...
    def spends(uid: str, key: str | None = None) -> list:
        with session_scope() as s:
            q = select(CreditLedgerRow.amount).where(CreditLedgerRow.user_id == uid, CreditLedgerRow.kind == "spend")
            if key is not None:
