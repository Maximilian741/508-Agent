...
<style>
  ...
  <p class="callout" style="background:#F6F7FB;border-left-color:#64748B;margin-top:24px">Generated by 508 Agent · Automated accessibility assessment, not a substitute for a formal manual WCAG 2.1 / Section 508 audit · ${_esc(date)}</p>
</body></html>`;
}
