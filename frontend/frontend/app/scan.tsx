...
const styles = StyleSheet.create({
  ...
  searchInput: { borderWidth: 1, borderRadius: 2, padding: 10 },
  ...
  diffPanel: { flex: 1, minWidth: 220, borderWidth: 1, borderColor: "#E0CFB0", borderRadius: 4, padding: 12 },
  ...
  canvas: { width: "100%", borderWidth: 1, borderColor: "#E0CFB0", borderRadius: 4 },
  overlayCanvas: {
    position: "absolute",
    left: 0,
    top: 0,
  ...
  overlayHint: {
    ...
    top: 12,
    right: 12,
    backgroundColor: "rgba(31, 20, 10, 0.7)",
    borderRadius: 4,
    padding: 10,
  },
