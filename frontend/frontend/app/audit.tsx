  ...
  <div class="page">
    ...
    <div class="body">
      ...
      <div class="conformance-callout">
        ...
        <strong>PDF note:</strong> table/list/heading <em>findings</em> are not itemised for PDFs at analysis time; instead, untagged PDFs are flagged whole and the remediated file receives a reconstructed structure tree (headings, lists, tables, figures, artifacts, links, form fields).<br>
