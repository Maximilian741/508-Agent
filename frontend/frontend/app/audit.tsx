  ...
  <div class="page">
    ...
    <div class="body">
      ...
      <div class="conformance-callout">
        ...
        <strong>Automated checks performed:</strong> image alt text, heading structure, table headers, list structure, slide titles, document title &amp; language, link text, colour contrast (WCAG 1.4.3 — explicit, theme &amp; PDF text colours, vs. white), and form-field labels (3.3.2 / 4.1.2 — PDF &amp; Word).<br>
